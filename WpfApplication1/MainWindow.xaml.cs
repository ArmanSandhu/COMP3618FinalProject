...
namespace WpfApplication1
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnSearch_ClickAsync(object sender, RoutedEventArgs e)
        {
            Search();
        }

        //calls search method when user double clicks on search box
        private void M_txtTest_MouseDoubleClickAsync(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            Search();
        }

        //calls search method when user hits enter in search box
        private void M_txtTest_KeyDownAsync(object sender, System.Windows.Input.KeyEventArgs e)
        {
        ...
        private void PreviousButton_ClickAsync(object sender, RoutedEventArgs e)
        {
            if (pageIndex > 0)
            {
                pageIndex--;
        ...
        private void NextButton_ClickAsync(object sender, RoutedEventArgs e)
        {
            pageIndex++;
            PageNumber.Content = pageIndex + 1;
            Search();
